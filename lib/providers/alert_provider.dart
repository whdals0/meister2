...
class AlertProvider extends GetConnect{
  ...
  // Get 호출
  Future<Response> getLists(String user_id, int pageKey) async {
    // Backend 로 요청할 URL 을 그대로 적어준다.
    final serverUrl = "${server_url}/alerts/list/${user_id}?page=${pageKey}";
  ...
  Future<Response> updateContent(int id, Map data) async {
    final server_api = "$server_url/alerts/${id}";
